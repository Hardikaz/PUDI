...
const vimi = () => {
    return (
        ...
        <p>Our vision is to offer packaging excellence characterized by excellent quality, unrivaled service, continuous improvement, and ongoing innovation in order to become one of the top flexible packaging companies in the market.</p>
        </div>
